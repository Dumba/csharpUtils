...
namespace ConsoleApplication1
{
    public class NormalizeText
    {
        ...
        {
            string output = "";
            foreach(char single in input)
            {
                string changed = single.ToString();
                try
                {
                    changed = LOCAL_CHAR_TO_URL[changed];
                }
        ...
        public static string toDwarf(string input)
        {
            string output = RemoveDiacritic(input)
                .ToLower()
                .Replace(". ", ":")
                .Replace('.', ':')
                .Replace(',', ' ')
